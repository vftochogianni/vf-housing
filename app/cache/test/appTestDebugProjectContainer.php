...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'subscriber.user_updated' => 'getSubscriber_UserUpdatedService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('UserUpdated', array(0 => 'subscriber.user_updated', 1 => 'onUserUpdated'), 0);
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_b5e66c0734243e35ab611b1340daf8161bcdcee0bec6aff6cc94147a8ab0b59c');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($g, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => new \Symfony\Component\Security\Core\User\InMemoryUserProvider(), 1 => $this->get('security.user.provider.concrete.our_db_provider')), 'main', $a, $c), 2 => $i, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $h, 'main', $j, $k, array('check_path' => 'myapp_login', 'username_parameter' => '_email', 'password_parameter' => '_password', 'use_forward' => false, 'require_previous_session' => true, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $f, 'main', $l, $a), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5a415172ce9598.61897535', $a, $f), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $g, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $h, 'main', $l, NULL, NULL, $a, false));
    }
     ...
     *
     * @return \VFHousing\UserBundle\Application\UserRegisteredSubscriber
     */
    protected function getSubscriber_UserRegisteredService()
    {
        return $this->services['subscriber.user_registered'] = new \VFHousing\UserBundle\Application\UserRegisteredSubscriber($this->get('user_repository.in_memory'));
    }

    /**
     * Gets the public 'subscriber.user_updated' shared service.
     *
     * @return \VFHousing\UserBundle\Application\UserUpdatedSubscriber
     */
    protected function getSubscriber_UserUpdatedService()
    {
        return $this->services['subscriber.user_updated'] = new \VFHousing\UserBundle\Application\UserUpdatedSubscriber($this->get('user_repository.in_memory'));
    }
    ...
    {
        return $this->services['tactician.command.debug'] = new \League\Tactician\Bundle\Command\DebugCommand(array('default' => array('VFHousing\\UserBundle\\Application\\RegisterUser' => 'register_user_handler', 'VFHousing\\UserBundle\\Application\\UpdateUser' => 'update_user_handler')));
    }
    ...
    {
        return $this->services['tactician.commandbus.default.handler.locator'] = new \League\Tactician\Bundle\Handler\ContainerBasedHandlerLocator($this, array('VFHousing\\UserBundle\\Application\\RegisterUser' => 'register_user_handler', 'VFHousing\\UserBundle\\Application\\UpdateUser' => 'update_user_handler'));
    }
    ...
    {
        return $this->services['update_user_handler'] = new \VFHousing\UserBundle\Application\UpdateUserDetailsHandler($this->get('debug.event_dispatcher'));
    }
